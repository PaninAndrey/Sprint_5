...
class Locators:
    ...
    NAME_INPUT = (By.XPATH, "//div[label[contains(text(),'Имя')]]//input") # Поле для ввода имени при регистрации
    EMAIL_INPUT = (By.XPATH, "//div[label[contains(text(),'Email')]]//input") # Поле для ввода email при регистрации
    PASSWORD_INPUT = (By.XPATH, "//div[label[contains(text(),'Пароль')]]//input") # Поле для ввода пароля при регистрации
...
class LocatorsForLogIn:
    ...
    EMAIL_INPUT_LOG_IN = (By.XPATH, "//div[label[contains(text(),'Email')]]//input") # Поле для ввода email при авторизации
    PASSWORD_INPUT_LOG_IN = (By.XPATH, "//div[label[contains(text(),'Пароль')]]//input") # Поле для ввода пароля при авторизации
